    ...
    return (
        <section id="home">
            ...
            <div style={{margin:"100px", display:"flex", flexDirection:'column', justifyContent:'center', alignItems:'center'}}>
                ...
                <Link to='https://open.spotify.com/intl-es/artist/2Yjvtj6PygasEQoDJbtm1N?si=rvc82iviSBePvb7ZB01-Tw' rel="noreferrer" target='_blank' className="linkBtn">Listen Us</Link>
                </div>
            </div>
        </section>
    )
